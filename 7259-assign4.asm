;Write ALP to accept 5 64 bit hexadecimal numbers and count the number of positive and negative numbers
...
section .data
	msg1 db "Write ALP to accept 5 64 bit hexadecimal numbers and count the number of positive and negative numbers",10
	msg1len equ $-msg1
